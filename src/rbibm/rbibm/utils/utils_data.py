...
POSTERIOR_SAMPLES_FOLDER = "posterior_samples"
...
def init_datarepo(name: str, root_path: Optional[str] = None):
    ...
    if not os.path.exists(path + SEP + POSTERIOR_SAMPLES_FOLDER):
        os.mkdir(path + SEP + POSTERIOR_SAMPLES_FOLDER)
...
def save_posterior_samples_by_id(name: str, id:str, samples_dict_top, samples_dict_tilde_top, samples_dict_rand, samples_dict_tilde_rand):
    full_dict = {"xs_top": samples_dict_top, "xs_tilde_top": samples_dict_tilde_top, "xs_rand": samples_dict_rand, "xs_tilde_rand": samples_dict_tilde_rand}
    path = DATA_PATH + name + SEP + POSTERIOR_SAMPLES_FOLDER + SEP + id + ".pkl"
...
def load_posterior_samples_by_id(name:str, id:str):
    path = DATA_PATH + name + SEP + POSTERIOR_SAMPLES_FOLDER + SEP + id + ".pkl"
