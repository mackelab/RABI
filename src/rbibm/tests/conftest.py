...
ROB_METRIC = [ReverseKLRobMetric, ForwardKLRobMetric]
...
TASKS = [LotkaVolterraTask, GaussianLinearTask, VAETask, HHTask, SIRTask, SpatialSIRTask]
TAKS_WITH_POTENTIAL = [LotkaVolterraTask, GaussianLinearTask, VAETask, HHTask, SIRTask]
